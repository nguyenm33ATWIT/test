...
/**
 * A class that implements a list of objects using array. Entries in a list have
 * positions that begin with 1. Duplicate entries are allowed.
 * 
 * @author nguyenm33
 *
 * @param <T>
...
public class ArrayList<T> implements ListInterface<T> {
	...
	/*
	 * Returns index of given entry, returns -1 if not found
	 */
	 ...
	 * is list's length before removal; checkIntegrity has been called.
	 */
