...
public interface ListInterface<T> {
	 ...
	 * 
	 * @param givenPisition An integer that indicates the position of the entry to
	 *                      be replaced.
	 * @param newEntry      The object that will replace the entry a the position
	 *                      givenPosition.
	 ...
	 * 
	 * @param anEntry The object that us the desired entry.
